...
"""
nombre=str(input("Introduzca una palabra: "))
while nombre<=len(nombre[:9]):
    nombre=str(input("Introduzca una palabra con un minimo de 8 letras: "))
    if nombre==len(nombre[:8]):
        print(f"*{nombre}#")
print(nombre.upper())